...
class UserControllerTest {
    ...
    void createNewUser() throws Exception {
        ...
        verify(userService, Mockito.times(1)).addModel(any(UserDto.class));
    }
    ...
    void updateUser() throws Exception {
        ...
        mvc.perform(patch("/users/" + userDto.getId())
                ...
                .andExpect(jsonPath("$.name", is(userDto.getName())))
                .andExpect(jsonPath("$.email", is(userDto.getEmail())));
        verify(userService, Mockito.times(1)).updateModel(anyLong(), any());
    }
    ...
    void getUserById() throws Exception {
        ...
        mvc.perform(get("/users/" + userDto.getId())
                ...
                .andExpect(jsonPath("$.name", is(userDto.getName())))
                .andExpect(jsonPath("$.email", is(userDto.getEmail())));
                verify(userService, Mockito.times(1)).findModelById(anyLong());
    }
    ...
    void getListUsers() throws Exception {
        ...
        verify(userService, Mockito.times(1)).getAllModels();
    }
